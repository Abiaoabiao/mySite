...
export const constantRoutes = [
...

  {
    ...
    redirect: '/project',
    name: 'Project',
    meta: { title: '项目管理', icon: 'el-icon-c-scale-to-original'},
    children: [
      {
        path: 'projects',
        name: 'Projects',
      ...
      },
      {
        ...
        meta: { title: '项目添加', icon: `el-icon-folder-add`, auth: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: {
          title: '评论', icon: 'el-icon-s-comment', auth: true
        }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: '留言板', icon: 'el-icon-chat-line-round', auth: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        meta: { title: 'External Link', icon: 'link', auth: true }
      }
    ]
  },
